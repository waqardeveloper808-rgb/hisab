...
import {
  applyArabicFontBeforePdfRender,
  chromiumLaunchOptionsForPdf,
} from "@/lib/document-engine/puppeteer-export";
  ...
  <head>
    ...
    <style>
      ...
      body {
        background: #f5f5f5;
        color: #172226;
        font-family: "Segoe UI", "Noto Naskh Arabic", Tahoma, Arial, "Helvetica Neue", sans-serif;
        line-height: 1.45;
        font-size: 12px;
      }
      .gh-document-page {
...
export async function renderDocumentPdf(bodyHtml: string) {
  ...
  try {
    ...
    await applyArabicFontBeforePdfRender(page, browser);
