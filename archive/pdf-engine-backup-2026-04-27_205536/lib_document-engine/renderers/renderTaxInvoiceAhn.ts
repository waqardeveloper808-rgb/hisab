...
export function getTaxInvoiceAhnCss() {
  return `
    .ahn-tax-invoice{font-family:'Segoe UI','Noto Sans Arabic',Tahoma,Arial,sans-serif;color:#13221c;background:#fff;padding:12mm;display:grid;gap:10px}
    ...
    .ahn-ar{font-family:'Noto Sans Arabic','Segoe UI',Tahoma,Arial,sans-serif}
    ...
    .ahn-lines{width:100%;border-collapse:collapse;font-size:11px;border:1px solid #d9e3db}
    .ahn-lines th,.ahn-lines td{border:1px solid #d9e3db;padding:5px 6px;vertical-align:top}
