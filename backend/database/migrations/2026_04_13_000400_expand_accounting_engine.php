...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('company_settings', function (Blueprint $table) {
            ...
            $table->string('default_payable_account_code', 20)->default('2100')->after('default_receivable_account_code');
            $table->string('default_expense_account_code', 20)->default('5100')->after('default_revenue_account_code');
