  ...
  return (
    <div className="space-y-6">
          ...
          <Card key={group.category} className="rounded-xl bg-white/95 p-6">
            ...
            <div className="mt-4 space-y-3">
              {group.questions.map((item) => (
                <div key={item.question} className="rounded-lg border border-line bg-surface-soft p-4 text-sm leading-6 text-muted">
      ...
      {!filteredGroups.length ? (
        <Card className="rounded-xl bg-white/95 p-6 text-sm text-muted">
