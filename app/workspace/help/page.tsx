    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <Link href="/workspace/help/faq">
          <Card className="rounded-[1.8rem] bg-white/92 p-6 hover:border-primary/25">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          {helpArticles.map((article) => (
            <Link key={article.slug} href={`/workspace/help/articles/${article.slug}`}>
              <Card className="h-full rounded-[1.5rem] border border-line bg-surface-soft p-5 hover:border-primary/25 hover:bg-white">
