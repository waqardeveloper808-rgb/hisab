  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      <Container>
        ...
        <div className="mt-8 grid gap-5 rounded-[1.9rem] border border-line bg-[linear-gradient(180deg,rgba(255,255,255,1),rgba(246,250,246,0.96))] p-6 shadow-[0_22px_44px_-36px_rgba(17,32,24,0.14)] lg:grid-cols-[1.05fr_0.95fr] lg:p-8">
          <div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-[1.4rem] border border-line bg-white px-4 py-4">
