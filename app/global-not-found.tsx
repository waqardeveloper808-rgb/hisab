...
export default function GlobalNotFound() {
  return (
    <html lang="en">
      <body className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f5f5f5_52%,#ffffff_100%)] text-ink">
        <main className="mx-auto flex min-h-screen w-full max-w-4xl items-center px-6 py-16 sm:px-8">
          <section className="w-full rounded-[2.4rem] border border-line bg-white/96 p-8 text-center shadow-[0_36px_82px_-42px_rgba(11,11,11,0.18)] backdrop-blur-xl sm:p-12">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-muted">
              The URL is not mapped to a live {appName} route. Use a verified destination below instead of continuing into a mixed shell state.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link href="/" className="inline-flex items-center justify-center rounded-2xl bg-primary px-5 py-3 text-sm font-semibold text-white shadow-[0_18px_34px_-22px_rgba(63,174,42,0.36)] hover:bg-primary-hover">Go to homepage</Link>
