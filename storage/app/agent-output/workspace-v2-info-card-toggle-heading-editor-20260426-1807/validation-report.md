...
- **PDF (if captured):** `C:\hisab\storage\app\agent-output\workspace-v2-info-card-toggle-heading-editor-20260426-1807\after-products-heading-edited-pdf.pdf`

## Telemetry

```json
{
  "visibilityToggleSection": "customer",
  "visibilityPanelSwitchCount": 5,
  "pdfPath": "C:\\hisab\\storage\\app\\agent-output\\workspace-v2-info-card-toggle-heading-editor-20260426-1807\\after-products-heading-edited-pdf.pdf"
}
```
