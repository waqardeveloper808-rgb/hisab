...
- **PDF (if captured):** `C:\hisab\storage\app\agent-output\workspace-v2-info-card-toggle-heading-editor-20260426-1805\after-products-heading-edited-pdf.pdf`

## Telemetry

```json
{
  "customerOptionalSwitchClicked": false,
  "pdfPath": "C:\\hisab\\storage\\app\\agent-output\\workspace-v2-info-card-toggle-heading-editor-20260426-1805\\after-products-heading-edited-pdf.pdf"
}
```
