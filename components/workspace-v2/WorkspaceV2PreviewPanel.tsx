...
import { formatCurrency, statusLabel, statusTone } from "@/lib/workspace-v2/format";
import {
  getSchemaForKind,
  type LangMode,
...
import { WorkspaceV2DocumentPreview } from "./WorkspaceV2DocumentPreview";
import { WorkspaceV2MoreActions, type MoreAction } from "./WorkspaceV2MoreActions";
...
export function WorkspaceV2PreviewPanel({ document, onClose, layout = "overlay" }: Props) {
    ...
    >
        ...
        <div className="wsv2-preview-actions">
          ...
          <span style={{ marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 6 }}>
            ...
            <WorkspaceV2MoreActions actions={moreActions} />
          </span>
        </div>
        {error ? (
          <div
        ...
        <div className="wsv2-preview-body">
          ...
          />
          <div style={{ height: 12 }} />
          <WorkspaceV2DocumentPreview document={document} language={language} />
        </div>
    </aside>
  );
