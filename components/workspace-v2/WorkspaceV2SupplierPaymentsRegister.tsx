...
import { findVendor } from "@/data/workspace-v2/vendors";
import { supplierPayments } from "@/data/workspace-v2/supplier-payments";
...
export function WorkspaceV2SupplierPaymentsRegister() {
    ...
    <div>
      ...
      <div className="wsv2-card" style={{ marginTop: 14 }}>
        ...
        <div className="wsv2-table-scroll">
          {rows.length === 0 ? (
            <WorkspaceV2EmptyState title="No payments match" />
          ) : (
