...
export function WorkspaceV2Dashboard() {
    ...
    <div>
      <div className="wsv2-page-header">
        ...
        <div className="wsv2-page-actions">
          <Link href={`${V2_BASE}/invoices`} className="wsv2-btn-secondary wsv2-icon-btn">
            <FileText size={14} /> Open invoice register
          </Link>
          <Link href={`${V2_BASE}/invoices`} className="wsv2-btn">
      ...
      >
          ...
          <div className="wsv2-list">
            {pendingInvoices.slice(0, 6).map((inv) => {
              ...
              return (
                <Link
                  key={inv.id}
                  href={`${V2_BASE}/invoices?doc=${inv.id}`}
        ...
        <section className="wsv2-card" aria-label="Quick actions">
          ...
          <div style={{ padding: 14, display: "grid", gap: 8 }}>
            <Link href={`${V2_BASE}/invoices`} className="wsv2-quick-action">
              <FileText /> Create tax invoice
            </Link>
            <Link href={`${V2_BASE}/quotations`} className="wsv2-quick-action">
              <FileBadge /> Issue a quotation
            </Link>
            <Link href={`${V2_BASE}/customer-payments`} className="wsv2-quick-action">
              <Wallet /> Record customer payment
            </Link>
            <Link href={`${V2_BASE}/products-services`} className="wsv2-quick-action">
              <Package /> Add product or service
            </Link>
            <Link href={`${V2_BASE}/templates`} className="wsv2-quick-action">
          ...
          <div className="wsv2-list">
            {recentPayments.map((payment) => {
              ...
              return (
                <Link
                  key={payment.id}
                  href={`${V2_BASE}/customer-payments`}
                  className="wsv2-list-item"
                  style={{ color: "inherit", textDecoration: "none" }}
                >
                  <div style={{ minWidth: 0 }}>
