...
import type { DocumentStatus } from "@/lib/workspace-v2/types";
import { statusLabel } from "@/lib/workspace-v2/format";
...
type Props = {
  ...
  onCreate?: () => void;
  createLabel?: string;
  /** Optional "Edit columns" control (e.g. <WorkspaceV2ColumnPicker />) */
  columnPicker?: ReactNode;
  /** @deprecated use columnPicker */
  onToggleColumns?: () => void;
};

export function WorkspaceV2RegisterToolbar({
  search,
  onSearchChange,
  statusFilter,
  onStatusChange,
