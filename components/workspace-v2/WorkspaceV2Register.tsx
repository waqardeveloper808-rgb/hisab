...
import type { DocumentRecord, DocumentStatus } from "@/lib/workspace-v2/types";
...
import { WorkspaceV2RegisterToolbar, type StatusFilterOption } from "./WorkspaceV2RegisterToolbar";
import { WorkspaceV2PreviewPanel } from "./WorkspaceV2PreviewPanel";
...
export function WorkspaceV2Register({ config }: Props) {
