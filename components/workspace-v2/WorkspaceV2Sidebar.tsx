...
import {
  ...
  navGroups,
  type NavGroup,
} from "@/lib/workspace-v2/navigation";
...
export function WorkspaceV2Sidebar({
  ...
  const isLinkActive = useCallback(
    (href: string) => {
      ...
      if (path === V2_BASE) {
        return pathname === V2_BASE || pathname === `${V2_BASE}/dashboard`;
      }
  ...
  const isDashboardActive =
    pathname === V2_BASE || pathname === `${V2_BASE}/dashboard`;
  ...
  return (
    <aside className="wsv2-sidebar" data-open={mobileOpen ? "true" : "false"}>
      ...
      <nav className="wsv2-sidebar-scroll" aria-label="Workspace V2 navigation">
        <Link
      ...
      <div className="wsv2-sidebar-footer">
        <span className="wsv2-nav-label">Workspace V2 candidate</span>
        <button
          type="button"
