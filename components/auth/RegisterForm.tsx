  ...
  return (
    <>
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <p className="text-center text-sm text-muted">Your account starts on the ZATCA Monthly trial plan and can keep one free invoice each month if you do not upgrade.</p>
