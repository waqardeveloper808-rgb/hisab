...
import { WorkspaceAppSidebar } from "./WorkspaceAppSidebar";
import { WorkspaceAppTopbar } from "./WorkspaceAppTopbar";
import { useIsMobile } from "@/lib/workspace/use-media-query";
...
export function WorkspaceAppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="wsv2-shell" data-collapsed={effectiveCollapsed ? "true" : "false"}>
      ...
      />
      <WorkspaceAppTopbar onOpenMobileSidebar={() => setMobileOpen(true)} />
