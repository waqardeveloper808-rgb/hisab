...
import { useWsV2Theme } from "@/lib/workspace/use-theme";

/**
 * Wraps Workspace content with a single attribute root that exposes the
 ...
 */
export function WorkspaceThemeBoundary({
  children,
}: {
