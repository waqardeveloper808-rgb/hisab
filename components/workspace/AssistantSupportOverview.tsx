      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_0.95fr]">
        ...
        <Card className="rounded-[1.8rem] bg-white/92 p-6">
          ...
          <div className="mt-5 space-y-3 text-sm text-muted">
            <div className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3">Start with the live customer record to confirm plan, owner, and account health before changing access or billing.</div>
            <div className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3">Move the customer into the invoice, report, or AI help flow from links that exist inside the live workspace.</div>
            <div className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3">Keep support explicit and commercial by moving from issue to workflow, not from issue to ticket backlog.</div>
          </div>
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <Link href="/workspace/admin/customers" className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3 text-sm font-semibold text-ink transition hover:border-primary/30 hover:bg-white hover:text-primary">
              Review customer accounts
            </Link>
            <Link href="/workspace/reports" className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3 text-sm font-semibold text-ink transition hover:border-primary/30 hover:bg-white hover:text-primary">
              Open reporting workspace
            </Link>
            <Link href="/workspace/help/ai" className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3 text-sm font-semibold text-ink transition hover:border-primary/30 hover:bg-white hover:text-primary">
              Launch AI help
            </Link>
            <Link href="/workspace/invoices/new" className="rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3 text-sm font-semibold text-ink transition hover:border-primary/30 hover:bg-white hover:text-primary">
              Start invoice flow
            </Link>
          </div>
        </Card>
