...
const actionConfig: Record<AuditAction, { label: string; icon: string; color: string }> = {
  ...
  zatca_reported: { label: "ZATCA reported", icon: "☑", color: "#1f7a53" },
  ...
  line_added: { label: "Line added", icon: "+", color: "#1f7a53" },
