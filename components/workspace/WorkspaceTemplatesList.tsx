...
export function WorkspaceTemplatesList() {
  return (
    <div>
      <div className="wsv2-page-header">
        ...
        <div className="wsv2-page-actions">
          <Link href={`${USER_WORKSPACE_BASE}/templates/studio`} className="wsv2-btn-secondary wsv2-icon-btn">
      ...
      <WorkspaceSuggestion
        ...
        description="Default templates are used when creating new documents of that type. Tax invoice, quotation, proforma, credit note, and debit note each can have a different default. In Workspace preview, default selection is shown but not persisted to the backend."
      />
                ...
                <tr key={tmpl.id}>
                  ...
                  <td>
                    <div className="actions">
                      <Link
                        href={`${USER_WORKSPACE_BASE}/templates/studio?template=${tmpl.id}`}
