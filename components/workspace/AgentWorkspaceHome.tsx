...
export function AgentWorkspaceHome() {
  ...
  useEffect(() => {
    getAgentDashboard().then(setSnapshot).catch(() => setSnapshot(emptyState));
  }, []);
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_0.95fr]">
        ...
        <Card className="rounded-[1.8rem] bg-white/92 p-6">
          ...
          <div className="mt-5 rounded-[1.3rem] border border-line bg-surface-soft px-4 py-3 text-sm text-ink">
