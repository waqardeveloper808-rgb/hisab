...
import { useSuggestionsEnabled } from "@/lib/workspace/use-suggestions";
import { clearAllDismissed } from "@/lib/workspace/suggestions";
import { WorkspaceSuggestion } from "./WorkspaceSuggestion";

export function WorkspaceUserProfile() {
        ...
        <section className="wsv2-card wsv2-card-tight" aria-label="Notification preferences">
          ...
          <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
            ...
            <ToggleRow
              ...
              hint="When off, dismissible tip cards across Workspace stay hidden."
              on={enabled}
              onChange={setEnabled}
            />
          </div>
