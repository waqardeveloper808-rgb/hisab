...
export function PlansOverview() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isPreview ? <div className="rounded-[1.2rem] border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-800">Preview mode shows the pricing-control layout only. Sign in as a platform admin to edit support defaults, plans, and feature flags.</div> : null}
      {! canManagePlans ? <div className="rounded-[1.2rem] border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">This account can view platform plans but cannot change pricing or support defaults.</div> : null}
