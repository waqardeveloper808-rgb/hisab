...
const fallbackCompanySettingsSnapshot: CompanySettingsSnapshot = {
  ...
  settings: {
    ...
    defaultReceivableAccountCode: "110",
    defaultPayableAccountCode: "200",
    defaultRevenueAccountCode: "400",
    defaultExpenseAccountCode: "690",
    defaultCashAccountCode: "120",
    defaultCustomerAdvanceAccountCode: "230",
    defaultSupplierAdvanceAccountCode: "125",
    defaultVatPayableAccountCode: "220",
    defaultVatReceivableAccountCode: "130",
