// Workspace V2 — shared layout/data builder.
//
// Schema-first contract: turns (schema, doc, seller, customer, language)
// into a structured `LayoutPlan` consumed by:
//   - Browser preview (components/workspace-v2/WorkspaceV2DocumentRenderer.tsx)
//   - PDF builder    (lib/workspace-v2/exports/pdf.ts)
//   - XML builder    (lib/workspace-v2/exports/xml.ts) — totals reconcile
//
// IMPORTANT:
...
function normalizeItemColumnWidths(
  ...
  const fitted = fitRawWidthsToTarget(keys, raw, targetPx, minG);
