// Workspace V2 — master document template schema (Wafeq Format 2 baseline).
//
// SINGLE CONTRACT consumed by:
//   1. Browser preview          components/workspace-v2/WorkspaceV2DocumentRenderer.tsx
//   2. Template Studio canvas   components/workspace-v2/WorkspaceV2TemplateStudio.tsx
//   3. PDF export               lib/workspace-v2/exports/pdf.ts
//   4. XML export               lib/workspace-v2/exports/xml.ts
//
...
const DEFAULT_ITEM_COLUMNS: ItemColumnSpec[] = [
  ...
  { key: "quantity",        widthPx: 46,  align: "right",  required: true,  format: "qty" },
  { key: "unit",            widthPx: 42,  align: "center", required: false, format: "text" },
  { key: "price",           widthPx: 72,  align: "right",  required: true,  format: "money" },
  { key: "taxableAmount",   widthPx: 82,  align: "right",  required: true,  format: "money" },
  { key: "vatRate",         widthPx: 48,  align: "right",  required: false, format: "percent" },
  { key: "vatAmount",       widthPx: 72,  align: "right",  required: true,  format: "money" },
  { key: "lineTotal",       widthPx: 76,  align: "right",  required: true,  format: "money" },
];
...
const SIMPLIFIED_TAX_INVOICE: DocumentTemplateSchema = {
  ...
  itemColumns: [
    { key: "index",        widthPx: 30,  align: "center", required: true },
    { key: "description",  widthPx: 308, align: "left",   required: true },
    { key: "quantity",     widthPx: 46,  align: "right",  required: true,  format: "qty" },
    { key: "price",        widthPx: 84,  align: "right",  required: true,  format: "money" },
    { key: "vatAmount",    widthPx: 80,  align: "right",  required: true,  format: "money" },
    { key: "lineTotal",    widthPx: 80,  align: "right",  required: true,  format: "money" },
  ],
...
const DELIVERY_NOTE: DocumentTemplateSchema = {
  ...
  itemColumns: [
    { key: "index",             widthPx: 30,  align: "center", required: true },
    { key: "description",       widthPx: 250, align: "left",   required: true },
    { key: "quantity",          widthPx: 60,  align: "right",  required: true,  format: "qty" },
    { key: "unit",              widthPx: 50,  align: "center", required: false, format: "text" },
    { key: "deliveredQuantity", widthPx: 80,  align: "right",  required: true,  format: "qty" },
    { key: "pendingQuantity",   widthPx: 80,  align: "right",  required: false, format: "qty" },
    { key: "remarks",           widthPx: 148, align: "left",   required: false, format: "text" },
  ],
...
const PURCHASE_ORDER: DocumentTemplateSchema = {
  ...
  itemColumns: [
    { key: "index",        widthPx: 30,  align: "center", required: true },
    { key: "description",  widthPx: 252, align: "left",   required: true },
    { key: "quantity",     widthPx: 56,  align: "right",  required: true,  format: "qty" },
    { key: "unit",         widthPx: 50,  align: "center", required: false, format: "text" },
    { key: "price",        widthPx: 84,  align: "right",  required: true,  format: "money" },
    { key: "vatAmount",    widthPx: 80,  align: "right",  required: false, format: "money" },
    { key: "lineTotal",    widthPx: 80,  align: "right",  required: true,  format: "money" },
  ],
